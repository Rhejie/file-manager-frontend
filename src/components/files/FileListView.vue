        ...
        <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
            ...
            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                ...
                <tbody class="bg-white">
                    <tr class="hover:bg-gray-300" v-loading="loadingData" v-for="(file, index) in f" @click="handleClickFilePreview(file)"  :key="file.id" :class="index % 2 === 0 ? undefined : 'bg-gray-50'">
